...
def CreateCompressedLayerHelper(n_in, n_out, config):
    compress_config = OmegaConf.create(config.compress_config)
    ...
    layer = blank_init(compress_config, n_in, n_out, config.torch_dtype, None)
    ...
    #     layer = PermutedLinear.blank_init(
    #         n_in,
    #         n_out,
    #         add_bias=compress_config.get("add_bias", False),
    #         dtype=config.torch_dtype,
